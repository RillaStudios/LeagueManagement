...
import NewsTeamCardList from "@/lib/components/ui/cards/news_team/news_team_card_list";
...
@Date: 2025-04-01
*/
export default async function TeamNewsMangagerPage({ params }: { params: Promise<{ id: number }> }) {
