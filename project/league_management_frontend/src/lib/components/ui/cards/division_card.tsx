...
const LeagueCard: React.FC<DivisionCardProps> = ({ division }) => {
            ...
            >
                ...
                >
                    <Container className="full md:w-auto">
                        <Image alt="Division Logo" src={"/images/lmsLogo.png"} width={100} height={100} style={{ objectFit: "cover" }} />
                        <div className="my-4" />
                        <HeadlineMedium text={`${division.divisionName}`} />
                        {league.location && league.location !== "" && <HeadlineMedium text={`${league.location}`} />}

                    </Container>
                    <Container>
                        <Separator className="my-4" />
                        <BodySmall text={`League ID: #${division.id}`} />
                    </Container>
